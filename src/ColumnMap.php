...
/**
 * class ColumnMap to manage output
 */
class ColumnMap extends Column
{
    private $map;

    public function __construct($name, $title, $map = [], $options = [])
    {
        ...
        if (count($map)) {
            ...
            switch ($name) {
                ...
                case 'impact':
                    $this->map = self::getImpactLabelsArray();
                    break;

                case 'urgency':
                    $this->map = self::getUrgencyLabelsArray();
                    break;

                case 'priority':
                    $this->map = self::getPriorityLabelsArray();
                    break;
    ...
    public function getPriorityLabelsArray()
    {
    ...
    public function getImpactLabelsArray()
    {
    ...
    public function getUrgencyLabelsArray()
    {
